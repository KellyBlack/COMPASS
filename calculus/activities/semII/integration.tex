  ...
  \item  Show that the area of a sphere of radius $R$ is $4\pi R^2$.
    ...
    \begin{subproblem}
      ...
      \item Determine the slope of the line perpendicular to the graph of the function at $x=a$.
        \vfill
      \item Suppose that a vector has components $1 \vec{\imath} + B \vec{\jmath}$. Determine a value of $B$ so that the vector is pointing in the same direction as the perpendicular line.
        \vfill
    \end{subproblem}
