...
\begin{problem}
  \item  A thin, circular piece of metal has a uniform charge. The center of the circle is the origin,
        ...
        center of the circle. Assume that the piece of metal has a uniform charge, $\lambda_q$ C/m. \\
  ...
  \begin{subproblem}
   ...
   \item The idea is to divide the ring into small pieces. Determine the charge in a small piece of the ring
    ...
    \item If the point above the ring is a distance $l$ over the origin and the radius of the circle is $r$,
