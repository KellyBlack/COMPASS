...
A horizontal line will be rotated around the $x$-axis to form a cylinder.
  \begin{subproblem}
    \item Make a sketch of the situation. First draw and label the axes.
    ...
    Indicate the small piece that will be rotated around the $x$-axis.
    ...
    \item  Determine the electric field at the small piece and determine the component that is perpindicular to the small piece.
    \vfill
