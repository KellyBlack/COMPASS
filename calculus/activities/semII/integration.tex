...
\item Determine the common denominator for each of the expressions below.
  \begin{subproblem}
    \item $\frac{1}{x-3} + \frac{1}{x^2-6x+9}$ \\
      Common Denominator: \framebox(250,50){~}
      \vfill
    \item $\frac{2}{x+2} + \frac{4}{x^2+x+1}$ \\
      Common Denominator: \framebox(250,50){~}
      \vfill
    \item $\frac{3}{x+2} + \frac{x}{x^2+x+1}$ \\
      Common Denominator: \framebox(250,50){~}
      \vfill
  \end{subproblem}
...
\item For each of the following functions write the general form of
  ...
  \begin{subproblem}
    \item $\frac{2x+1}{x^2-6x+9}$ \\
      General Form: \framebox(250,50){~}
      \vfill
    \item $\frac{2x^2+6x+10}{x^3+3x^2+3x+2}$ \\
      General Form: \framebox(250,50){~}
      \vfill
    \item $\frac{3x^2+4x+2}{x^3+3x^2+3x+2}$ \\
      General Form: \framebox(250,50){~}
      \vfill
  \end{subproblem}
