...
\item Determine the area of the slice of a sector shown below in terms of
  ...
  \begin{tikzpicture}[scale=3.5,>={Latex[angle=45:5pt 2]}]
    ...
    \draw[black] (0.05,0.0866) arc (60:120:.1);
    \begin{scope}[shift={(0.04,-0.025)}]
      \draw[black] (60:1) -- ++(-30:0.6);
      \draw[black] (0,0) -- ++(-30:0.6);
      \draw[black,<-] (-30:0.5) -- ++(60:0.3) node at ++(60:0.2) {$L_1$};
      \draw[black,->] (0.76,0.38) -- ++(60:0.3);
      \draw[black] (60:0.85) -- ++(-30:0.15);
      \draw[black,<-] (-30:0.1) -- ++(60:0.2) node at ++(60:0.1) {$L_2$};
      \draw[black,->] (0.3,0.3) -- ++(60:0.45);
    \end{scope}
    %\node[anchor=north west,font=\small] at (60:0.45) {$L_2$};
    \node[anchor=north west,font=\small] at (60:0.92) {$\triangle L$};
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.5]
     ...
     \begin{tikzpicture}[scale=1.5]
       ...
       \draw[thick,blue,->] (-1.5,0.5) arc (90:300:0.3 and 0.5);
       \fill[top color=gray!50!black,bottom color=gray!10,middle color=gray,shading=axis,opacity=0.25,shading angle=0] (3.5,0) circle (0.2 and 1);
       \fill[left color=gray!50!black,right color=gray!50!black,middle color=gray!50,shading=axis,opacity=0.25,shading angle=0] (3.5,-1) -- (5.5,-1) arc (-90:90:0.2 and 1) -- (3.5,1) arc (90:270:0.2 and 1);
       \fill[top color=gray!90!,bottom color=gray!2,middle color=gray!30,shading=axis,opacity=0.25,shading angle=0] (5.5,0) circle (0.2 and 1);
...
\begin{center}
 ...
 \begin{center}
   \begin{tikzpicture}[scale=1.5,>={Latex[angle=45:5pt 2]}]
     \fill[left color=gray!02!gray!10,right color=gray!02!gray!10,middle color=gray!02,shading=axis,opacity=0.05,shading angle=0,fill opacity=0.05] (2.7,1.5) -- (3.3,1.5) arc (90:270:0.2 and 1.5) -- (2.7,-1.5) arc (270:90:0.2 and 1.5);
     ...
     \node[anchor=north] at (1.5,0) {$x$};
     \node[anchor=north east] at (0,0) {$q$};
     \fill[left color=gray!10!gray!30,right color=gray!10!gray!30,middle color=gray!10,shading=axis,shading angle=0,fill opacity=0.05] (2.7,1.5) -- (3.3,1.5) arc (90:-90:0.2 and 1.5) -- (2.7,-1.5) arc (-90:90:0.2 and 1.5);
