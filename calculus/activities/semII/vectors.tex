...
\item We will try to determine the formula for the line where two planes intersect.
  ...
  \begin{subproblem}
  \item Looking at the graph above, draw the vector perpindicular to
    the first plane. Then draw the vector perpindicular to the second
    plane.
  \item Mark a point that is located in both planes.
  \item Draw a vector that is in the direction of the line of intersection.
  \item If you are given the formulas for the two planes can you determine normal vectors to both planes?
