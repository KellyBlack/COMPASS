...
\item Suppose that $P$ is a point on a plane, and $\vec{n}$ is a vector that is perpendicular to the plane.
  ...
  \begin{subproblem}
    ...
    \item What is the angle between the vector $\overrightarrow{QP}$ and the vector $\vec{n}$?
      \vspace{3em}
    \item What can you say about the dot product as well as the cross product of the vectors $\overrightarrow{QP}$ and $\vec{n}$? Which is an easier relationship to work with?
