...
\item Suppose that $P$ is a point on a plane, and $\vec{n}$ is a vector that is perpendicular to the plane at the point $P$.
  ...
  \begin{subproblem}
    ...
    \item What is the angle between the vector $\overrightarrow{PQ}$ and the vector $\vec{n}$?
      \vspace{3em}
    \item What can you say about the dot product and the cross product of the vectors $\overrightarrow{PQ}$ and $\vec{n}$? Which is an easier relationship to work with?
    ...
    \item Assume that the vector that is perpindicular to a plane is $\vec{n}=a\hat{\imath}+b\hat{\jmath}+c\hat{k}$ where $a$, $b$, and $c$ are constants.
      ...
      \vfill
      \clearpage
    \item Suppose that the point $P=3\hat{\imath}-1\hat{\jmath}+2\hat{k}$ is on a plane, and the vector $\vec{n}=-5\hat{\imath}+4\hat{\jmath}-1\hat{k}$ is perpendicular to the plane.
...
\item Suppose that $P$ is a point above a plane, and $\vec{n}$ is a vector that is perpendicular to the plane.
  ...
  \begin{subproblem}
    ...
    \item What is the relationship between $\overrightarrow{PQ}$ and $\overrightarrow{SQ}$?
      \vfill
    \item Identify and label the angle $\theta$ between $\overrightarrow{PQ}$ and $\overrightarrow{SQ}$.
      \clearpage
      ...
      \item Which part of the triangle represents the distance between the point $P$ and the Plane?
         Determine the distance in terms of $\theta$ and $\overrightarrow{SP}$.
        \vfill
      ...
      \item If $\overrightarrow{PQ}$ is parallel to $\vec{n}$ then there is a constant $c$ where $\overrightarrow{SQ}=c\vec{n}$.
