...
\item The velocity for an object is given in the plot below. Assume
  that the object starts at $x=-1$m.
    ...
    \begin{subproblem}
    \item Determine the object's position at $t=1$ sec.
      \vfill
    \item Determine the object's position at $t=2$ sec.
      \vfill
    \item Determine the object's position at $t=3$ sec.
      \vfill
    \item Determine the object's position at $t=4$ sec.
      \vfill
    \end{subproblem}
...
\item The graph of the position of an object is given below.
  ...
  \item Make a rough approximation of the slope of the tangent line.
    \begin{itemize}
    \item slope at $t=1$:
    \item slope at $t=2$:
    \item slope at $t=2$:
