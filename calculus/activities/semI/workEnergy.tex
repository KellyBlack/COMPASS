...
\qrcode[height=1.5cm,hyperlink,tight]{https://kellyblack.github.io/COMPASS/html/calcOne.html#goals-for-activity-20}
...
\qrcode[height=1.5cm,hyperlink,tight]{https://kellyblack.github.io/COMPASS/html/calcOne.html##goals-for-activity-21}

\begin{problem}
\item A 2 kg object starts from rest on a straight track, and it can
  only move left or right. A force is applied to the object in the
  $\vec{i}$ direction, and the magnitude is shown in the plot below.
