...
\item Suppose that as the block is pulled the granite grinds off on
  the bottom. It starts at a mass of 500 kg. Mass is removed at 2\%
  per meter. Assume that the block starts at the origin, $x=0$ and
  assume that the angle is $\alpha=\frac{\pi}{6}$. The coefficient of
  friction is 0.2.
...
\item The block used in the previous activity is examined, and we wish
  ...
  that the angle is $\alpha=\frac{\pi}{6}$. The coefficient of
  friction is 0.2.
